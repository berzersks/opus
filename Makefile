...
AWK = nawk
shared_objects_opus = opus.lo opus_channel.lo
PHP_PECL_EXTENSION = opus
PHP_MODULES = $(phplibdir)/opus.la
PHP_ZEND_EX =
...
EXTRA_LDFLAGS =
EXTRA_LIBS =
INCLUDES = -I/usr/include/php/20230831 -I/usr/include/php/20230831/main -I/usr/include/php/20230831/TSRM -I/usr/include/php/20230831/Zend -I/usr/include/php/20230831/ext -I/usr/include/php/20230831/ext/date/lib -I/
LFLAGS =
LDFLAGS =
SHARED_LIBTOOL =
...
./opus.la: $(shared_objects_opus) $(OPUS_SHARED_DEPENDENCIES)
	$(LIBTOOL) --tag=CC --mode=link $(CC) -shared $(COMMON_FLAGS) $(CFLAGS_CLEAN) $(EXTRA_CFLAGS) $(LDFLAGS)  -o $@ -export-dynamic -avoid-version -prefer-pic -module -rpath $(phplibdir) $(EXTRA_LDFLAGS) $(shared_objects_opus) $(OPUS_SHARED_LIBADD)
